...
// //       >
// //         <div>
// //           <h1 className="text-base font-bold text-gray-800 font-neueHaas">
// //             My Calendar
// //           </h1>
// //           {/* Dynamic Subtitle */}
// //           <small className="text-gray-500">{selectedOption}</small>
// //         </div>

// //         {/* Parent Container for Full Width */}
// //         <div className="w-full">
// //           {/* Custom Dropdown */}
// //           <div className="relative w-full">
// //             <button
...
// //                 {selectedOption === "Upcoming Interviews" ? "" : selectedOption}
// //               </span>
// //               {/* Dropdown Icon */}
// //               <svg
// //                 xmlns="http://www.w3.org/2000/svg"
...
// //                 >
// //                   <ul className="w-full bg-white border border-gray-300 rounded-lg shadow-lg overflow-hidden">
// //                     {options.map((option, index) => (
// //                       <motion.li
// //                         key={index}
// //                         onClick={() => {
...
//           <h1 className="text-base font-bold text-gray-800 font-neueHaas">My Calendar</h1>
//           </div>
...
//           <button
//             onClick={() => setIsOpen(!isOpen)}
//             // className="flex justify-between items-center w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm text-left focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
//             className="flex justify-between items-center w-full px-4 py-2 rounded-lg shadow-sm text-left focus:outline-none"
//           >
//           <small className="absolute text-gray-500">
//           {selectedOption === "Upcoming Interviews"
//                 ? ""
//                 : selectedOption}
//           </small>
...
//                 exit={{ opacity: 0, y: -10 }}
//                 transition={{ duration: 0.2 }}
//                 className="absolute top-full right-0 mt-1 bg-white border border-gray-300 rounded-lg shadow-lg overflow-hidden z-10 w-full"
//               >
//                 {options.map((option, index) => (
//                   <motion.li
//                     key={index}
